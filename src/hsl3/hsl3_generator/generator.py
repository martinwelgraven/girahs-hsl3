...
import argparse
from hsl3.hsl3_generator.parsers.json import parse_json
...
def main():
    ...
    if args.source == 'config.xml' and not os.path.exists('config.xml'):
        print('No source file provided and default \'config.xml\' does not exist. Please provide a source file using the -s or --source argument.')
        return
